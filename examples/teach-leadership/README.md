...
GitHub shows the *source* of `.html` files, not the rendered page. To actually
read a lesson, use one of these:
...
| `learning-records/` | (appears once the learner demonstrates understanding) Decisions about what they now know, steering future sessions. |
...
```
/teach how to be a strong leader
```

Answer the mission questions, and your own workspace will grow lesson by lesson
just like this one.
